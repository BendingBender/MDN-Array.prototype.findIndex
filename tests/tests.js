...
function runTests(findIndex) {
  ...
  describe('Array#findIndex', function () {
    ...
    it('should find item key by predicate', function () {
      var result = findIndex.call(list, function (item) {
        return item === 15;
      });
...
module.exports = function run(requireTestee) {
  ...
  origFindIndex = Array.prototype.findIndex;
  delete Array.prototype.findIndex;

  requireTestee();

  implementation = Array.prototype.findIndex;
  if (origFindIndex) {
